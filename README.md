...
> Answer: Faster interactions once the website fully loads.
- [ ] What does AJAX stand for?
> Answer: asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: Any input form element that is controlled by React (user input)
- [ ] Name three tools/libraries for making AJAX requests.
> Answer: Fetch axios and request
